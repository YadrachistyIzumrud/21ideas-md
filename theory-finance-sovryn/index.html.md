...
Для того чтобы начать пользоваться платформой необходимо подключить криптовалютный кошелек. На выбор доступны 3 вида решений:

1.   Аппаратные решения: Ledger и Trezor;
2.   Мобильные приложения: D’cent, Math, Rwallet, Defiant;
3.   Браузерные расширения: Liquality, Metamask, Portis;

<figure class="kg-card kg-image-card"><img alt="" class="kg-image" height="660" loading="lazy" sizes="(min-width: 720px) 720px" src="https://www.21ideas.org/content/images/2022/03/Screen-Shot-2022-03-11-at-9.58.28-AM.png" srcset="https://www.21ideas.org/content/images/size/w600/2022/03/Screen-Shot-2022-03-11-at-9.58.28-AM.png 600w, https://www.21ideas.org/content/images/size/w1000/2022/03/Screen-Shot-2022-03-11-at-9.58.28-AM.png 1000w, https://www.21ideas.org/content/images/size/w1600/2022/03/Screen-Shot-2022-03-11-at-9.58.28-AM.png 1600w, https://www.21ideas.org/content/images/2022/03/Screen-Shot-2022-03-11-at-9.58.28-AM.png 1936w" width="1936"/></figure>

Внутренний токен SOV используется для участия в системе Bitocracy, получения права голоса, выплаты комиссий, распределения вознаграждений, стейкинга, делегирования или обеспечения пула ставок, созданного для компенсации возможных убытков при обеспечении функционирования протокола. 

Внутренний токен SOV является токеном управления протоколом и может быть подвержен сильным ценовым колебаниям, поскольку его ценность генерируется исходя из возможностей и применения протокола Sovryn. Учитывайте это при использовании токена на платформе.

<figure class="kg-card kg-image-card kg-card-hascaption"><img alt="" class="kg-image" loading="lazy" src="https://lh4.googleusercontent.com/d_K60xAZf33PLjGjUmHS7eXwXc-0so56pCbblRSBsInh5zTNWW-kJEBKzUXIkbCdZhLcCBrP0Al8W82JwfnAZcml9Q9UyvcPgvQbuKdkdhw1ADrzLL9R6YVigMTgH3a3rNlKJlDL"/><figcaption>Изначальное распределение токенов SOV</figcaption></figure>

Первоначальное распределение токенов SOV:

*   Фонд учредителей: распределение токенов среди разработчиков и команды проекта, линейный вестинг в течение трех лет;
*   Фонд распространения: распределение токенов среди пользователей при помощи реферальных программ, наград за обеспечение ликвидности и предоставления скидок;
*   Ранние спонсоры: распределение токенов среди ранних последователей и инвесторов протокола, линейный вестинг от 10 до 24 месяцев;
*   Фонд разработки: используется для выплаты грантов и вознаграждений за вклад в развитие протокола;
*   Экосистемный фонд: используется для выплат баунти-программ и экосистемных инициатив по привлечению новых пользователей, а также в целях обеспечения партнерств с другими DeFi-проектами на Биткоине;
*   Продажа токенов: продажа токенов инвесторам, участникам и стейкхолдерам.

Токены SOV можно приобрести внутри платформы на Swap Exchange или за пределами сети RSK на таких централизованных биржах как [Gate](https://www.gate.io/trade/sov_usdt?ref=3386543), [KuCoin](https://www.kucoin.com/ucenter/signup?rcode=PKbaNM), [AscendEx](https://ascendex.com/en/basic/cashtrade-spottrading/usdt/sov) (Bitmex) и на DEX – [Uniswap](https://app.uniswap.org/#/swap), [Sushiswap](https://app.sushi.com/swap).

<h2 id="%D1%82%D0%BE%D1%80%D0%B3%D0%BE%D0%B2%D0%BB%D1%8F">Торговля</h2>

Для обеспечения возможностей торговли применяется механизм автоматического маркет-мейкера (АММ). Оракулом для поставки данных является Money-on-Chain, а в скором будущем интегрируют и Chainlink. Торговля обеспечивается за счет пулов ликвидности, в которых пользователи могут блокировать свои средства, получая комиссии в качестве вознаграждений и стимулов. В отличие от АММ, использующихся на Uniswap и ему подобных, на площадке Sovryn не обязательно вносить оба актива в пул. Комиссия за совершение свопов составляет 0,1%. 

Комиссия уплачивается пользователями за каждую совершенную сделку. На данный момент она установлена ​​​​на уровне 0,15% для открытия каждой позиции. При закрытии позиций комиссия не взимается.

Ниже представлен список доступных торговых пар на платформе. Стоит отметить, что платформа развивается и количество представленных активов, доступных для торговли, может меняться.

<figure class="kg-card kg-image-card"><img alt="" class="kg-image" loading="lazy" src="https://lh5.googleusercontent.com/rrwtzLD-Hiz_Z27QIexKXyABTui-_Iej4zSO1BL6qR57IiHxVIIvCmvdSFO_EzvcbTJmwdB8Z6nEIqkYeO2vPw37VyNQ9ttI5boJXp__1SKBdyBpe5GLgK6VKeIjIj1oiMct87mK"/></figure>
...
<figure class="kg-card kg-image-card"><img alt="" class="kg-image" loading="lazy" src="https://lh5.googleusercontent.com/esiklO1rKOQwIcn2nB1aQJ_4zlDYYwcQBYdrGAykABBmAyB4xgYbdWpD0JlqIcRDqHrQTVlAPThjWtSbqALzv1zAWSjqWZ8i19zkxgn_9h84pq9otulbtELuxzF7Z4I0WKdCp1Jr"/></figure>
...
При подключении кошелька и отправке средств в смарт-контракт доступ к информации об активах можно получить через раздел “Portfolio”. Здесь представлена информация о токенах (в том числе NFT) и история активности кошелька на платформе. Мосты с другими сетями уже реализованы в виде удобного и простого веб-интерфейса.
