 >  _Пояснение механизма работы Lightning Network подготовлено _<a href="https://medium.com/@x0100?source=post_page-----7c618c9cd68----------------------" rel="noopener noreferrer">_Дмитрием Лаптевым_</a>_. &nbsp;_Данная статья также доступна на <a href="https://medium.com/@x0100/lightning-network-45b4b2119d97" rel="noopener noreferrer">английском</a>.
...
<h2 id="12-%D1%81%D0%B5%D1%82%D1%8C-%D0%BF%D0%BB%D0%B0%D1%82%D0%B5%D0%B6%D0%BD%D1%8B%D1%85-%D0%BA%D0%B0%D0%BD%D0%B0%D0%BB%D0%BE%D0%B2">1.2. Сеть платежных каналов</h2>
...
>  💡_ Когда платежные каналы выстраиваются в сеть, появляется возможность проводить платежи между любыми участниками, между которыми есть путь в графе этой сети (даже если они не связаны напрямую). Это и есть основная идея Lightning Network._

<figure class="kg-card kg-image-card kg-card-hascaption"><img alt="" class="kg-image" height="970" loading="lazy" sizes="(min-width: 720px) 720px" src="https://www.21ideas.org/content/images/2021/12/image-25.png" srcset="https://www.21ideas.org/content/images/size/w600/2021/12/image-25.png 600w, https://www.21ideas.org/content/images/size/w1000/2021/12/image-25.png 1000w, https://www.21ideas.org/content/images/2021/12/image-25.png 1584w" width="1584"/><figcaption><em>Так выглядел граф платежных каналов на момент 22.01.2018 (<a href="https://lnmainnet.gaben.win/" rel="noopener noreferrer">https://lnmainnet.gaben.win</a>).</em></figcaption></figure>
...
<h2 id="13-%D0%BF%D1%80%D0%BE%D0%B1%D0%BB%D0%B5%D0%BC%D0%B0-%D0%B4%D0%BE%D0%B2%D0%B5%D1%80%D0%B8%D1%8F">1.3. Проблема доверия</h2>
...
<h1 id="2-%D1%81%D0%BC%D0%B0%D1%80%D1%82-%D0%BA%D0%BE%D0%BD%D1%82%D1%80%D0%B0%D0%BA%D1%82%D1%8B">2. Смарт-контракты</h1>

Биткоин поддерживает простейший <a href="https://en.bitcoin.it/wiki/Script" rel="noopener noreferrer">язык смарт-контрактов _Script_</a>. В каждой биткоин-транзакции есть специальное поле, которое содержит скрипт на этом языке. Этот скрипт проверяет, при выполнении каких условий выход транзакции может быть потрачен.
...
1.   Алиса и Боб создают транзакцию/транзакции, которые зачисляют средства на общий адрес-депозит _O_. Предположим, что _X_ биткоинов зачисляется с кошелька Алисы и _Y_ — с кошелька Боба. Средства с общего депозита можно потратить только при подписании одновременно ключами Алисы и Боба (OP\_CheckMultiSig).
...
<figure class="kg-card kg-image-card kg-card-hascaption"><img alt="" class="kg-image" height="379" loading="lazy" src="https://www.21ideas.org/content/images/2021/12/image-27.png" width="564"/><figcaption><em>Финальный вид транзакций, используемых для платежного канала.</em></figcaption></figure>
...
<h2 id="42-%D0%BC%D0%B0%D1%80%D1%88%D1%80%D1%83%D1%82%D0%B8%D0%B7%D0%B0%D1%86%D0%B8%D1%8F">4.2. Маршрутизация</h2>
...
<figure class="kg-card kg-image-card kg-card-hascaption"><img alt="" class="kg-image" height="1127" loading="lazy" sizes="(min-width: 720px) 720px" src="https://www.21ideas.org/content/images/2021/12/Screen-Shot-2021-12-23-at-1.33.22-AM.png" srcset="https://www.21ideas.org/content/images/size/w600/2021/12/Screen-Shot-2021-12-23-at-1.33.22-AM.png 600w, https://www.21ideas.org/content/images/size/w1000/2021/12/Screen-Shot-2021-12-23-at-1.33.22-AM.png 1000w, https://www.21ideas.org/content/images/size/w1600/2021/12/Screen-Shot-2021-12-23-at-1.33.22-AM.png 1600w, https://www.21ideas.org/content/images/2021/12/Screen-Shot-2021-12-23-at-1.33.22-AM.png 2182w" width="2000"/><figcaption><em>Географическое распределение узлов тестовой сети (</em><a href="https://explorer.acinq.co/#/" rel="noopener noreferrer"><em>https://explorer.acinq.co/#/</em></a><em>).</em></figcaption></figure>
...
Не вдаваясь в подробности, поиск пути и передача платежей в LN реализуется на основе <a href="https://ru.wikipedia.org/wiki/%D0%9B%D1%83%D0%BA%D0%BE%D0%B2%D0%B0%D1%8F_%D0%BC%D0%B0%D1%80%D1%88%D1%80%D1%83%D1%82%D0%B8%D0%B7%D0%B0%D1%86%D0%B8%D1%8F" rel="noopener noreferrer">_Onion routing_</a> — технологии анонимного распространения информации по peer-to-peer сетям. Именно так, например, работает <a href="https://www.torproject.org/" rel="noopener noreferrer">Tor</a>.
...
<h2 id="43-%D1%8D%D0%BA%D0%BE%D0%BD%D0%BE%D0%BC%D0%B8%D0%BA%D0%B0-%D0%BA%D0%BE%D0%BC%D0%B8%D1%81%D1%81%D0%B8%D0%B9">4.3. Экономика комиссий</h2>

Остается два очевидных вопроса.

__Вопрос номер 1:__ зачем посредникам обрабатывать чужие платежи?
...
__Вопрос номер 2:__ а как же комиссия за открытие/закрытие канала?
